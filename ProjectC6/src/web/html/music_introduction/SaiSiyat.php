                    ...
                    <div class=" col-lg-9 ">
                        <div>
                            <ul style="font-size: 25px; color: black; margin: 30px;">
                                <font face="DFKai-sb">
                                    <h1 class="musictop">歌 謠 介 紹-賽夏族</h1>
                                    <ul style="margin: 10px;">
                                        <li style="font-size: 20px;"> 　賽夏族的歌謠大致可分為矮靈祭的祭歌與一般所唱的歌。其中以矮靈祭祭歌最為重要，並且平日禁唱。
                                            賽夏族兩年一度的矮靈祭，是賽夏族感謝與追思矮靈taai的祭典，也是台灣原住民各族中唯一以其他族群為祭祀
                                            對象的祭典。矮靈祭祭歌共有十六首，每首分若干節，每一節句數不一，但每句都含七個音節，每節以一種植物
                                            的名稱之尾音押韻。演唱時，以三種方式反覆唱出每一章節的詞句，每一反覆的結尾大多為襯字或母音唱法。整
                                            套矮靈祭祭歌的詩形整齊，好像一種結構龐大的史詩形式。全部唱完大約要超過四個小時，堪稱是台灣原住民音
                                            樂中最獨特的文化瑰寶。
                                        </li>
                                        <li style="font-size: 20px;">
                                            　　賽夏族舞蹈僅見于矮靈祭儀式中。矮靈祭舞蹈的部份非常單純，除了臀鈴外，就只有老人唱祭歌來配合舞蹈。
                                            舞步只是很簡單的雙腳前後、左右慢慢移動，有時則以快步的方式，有時則是用慢步走路的方式，形成一個不
                                            規則的百步蛇圖騰的形狀。這就是賽夏族對矮人心境的一種表達方式。
                                        </li>
                                        <p>
                                            參考資料:<br>
                                            原住民族委員會<br>
