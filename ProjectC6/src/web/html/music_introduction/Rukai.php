                    ...
                    <div class=" col-lg-9 ">
                        <div>
                            <ul style="font-size: 25px; color: black; margin: 30px;">
                                <font face="DFKai-sb">
                                    <h1 class="musictop">歌 謠 介 紹-魯凱族</h1>
                                    <ul style="margin: 10px;">
                                        <li style="font-size: 20px;">
                                            　　魯凱族音樂，在歌謠方面可分為祭儀歌謠、生活歌謠、童謠。其中祭儀歌謠與階級制度有密切的關係。生活性歌謠則往往與男女之間的愛情有關。
                                        </li>
                                        <li style="font-size: 20px;">
                                            　　演唱方式則可分為單音性與多音性兩種。單音性主要是獨唱時唱的，也有齊唱與領唱和腔的情形。多音性的歌謠幾乎全部以持續低音（drone 　
                                            bass）
                                            來唱，通常分成兩部，上聲部是以獨唱擔任旋律，下聲部是以合唱唱出持續低音。結婚儀式的歌唱也有異音唱法的情形。
                                        </li>
                                        <li style="font-size: 20px;">
                                            　　在樂器方面，魯凱族傳統樂器包括口簧琴、弓琴、鼻笛、口笛等，與排灣族甚為相似。可惜弓琴與口簧琴今日以不復可見了。
                                        </li>
                                        <li style="font-size: 20px;">
                                            　　魯凱族傳統舞在一般儀式中比較少出現。它其實是一種社會性的活動，男女都要盛裝參加，未婚女子的舉止尤其必須端莊。頭目家的前庭過去是舉行
                                            歌舞的地方。與排灣族的舞蹈相同，魯凱族的傳統舞蹈並無樂器伴奏，是由參加舞蹈者邊歌邊舞；有時男女分開成兩個圓，男在外、女在內跳，男女
                                            唱不同的歌來配舞。此時女子唱優雅的慢歌，而舞步較緩；男子則是五部與歌曲變化較巨。一般聚會歌舞時。眾人則隨四步拍子跳四步舞，很少變化。
                                        </li>
                                        <p>
                                            參考資料:<br>
                                            原住民族委員會<br>
