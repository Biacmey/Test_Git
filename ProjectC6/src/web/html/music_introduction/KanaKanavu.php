                                ...
                                <font face="DFKai-sb">
                                    ...
                                    <ul style="margin: 10px;">
                                        <li style="font-size: 20px;">
                                            卡那卡那富族最常用的樂器主要有以下數種：<br>

                                            一、嘴琴，以薄竹片製作，中央鑿長方形的洞，把口貼於洞中，用手拉線，以發出聲音的樂器。<br>
                                            二、弓琴，把竹子彎成弓形，再繃上由草的纖維所做成的絃，把口靠近絃的上端，手則握住下端，並以手指調整音調以發出聲音的樂器。<br>
                                            三、鼻笛，用兩根竹子製作，中央鑿數個洞，把鼻子靠在竹子上端，把氣吹進去，用手指按住洞口以調整音調和發出聲音的樂器。（臺灣總督府臨時臺灣舊慣調查會，2001〔1918〕）<br>
                                            　　族人最常用的樂器為嘴琴，在小米開始收穫的四天以後，會使用鼻笛吹奏音樂，直到小米收穫結束，平時則禁止使用，族人相信如果平常使用鼻笛吹奏，會招來暴風雨。（臺灣省文獻委員會編，1965；臨時臺灣舊慣調查會，1983〔1915〕）<br>

                                            　　在卡那卡那富族的傳統音樂中，偶爾也用兩聲部的複音方式來演唱，不過大部份的歌謠都是以齊唱的方式來進行。並分祭儀用的祭歌，又稱為古老的歌，和非祭儀用的生活歌曲，例如情歌、勸世歌、童謠等等。（游仁貴等，1999）<br>
