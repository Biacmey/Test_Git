                    ...
                    <div class=" col-lg-9 ">
                        <div>
                            <ul style="font-size: 25px; color: black; margin: 30px;">
                                <font face="DFKai-sb">
                                    <h1 class="musictop">歌 謠 介 紹-邵族</h1>
                                    <ul style="margin: 10px;">
                                    <li style="font-size: 20px;">　　1922年張福興的《水社化蕃杵の音と歌謠》，為日治時期邵族音樂研究最早的文獻資料，當時因日月潭電力工程興建、水社邵族人被迫遷徙，日人派遣學者進行行前調查的一份調查報告書，日後這份文獻也是研究邵族音樂引用最多的一份史料。至第二次世界大戰以後，研究日益蓬勃。</li>
                                    <li style="font-size: 20px;">　　根據功能性，邵族音樂可分成祭儀性的與非祭儀性的音樂，而依據樂種又可分成歌樂與器樂兩類，目前邵族部落僅存的器樂為木杵與竹筒，以往文獻中所描述的弓琴、口簧琴現已不易見到。基本上，邵族的非祭儀性歌謠大多以生活性或者商業觀光為主，根據吳榮順與李壬癸的採錄，一共約15首，包括懷舊、訂婚、接客人、搖籃曲、打獵、情歌等，這些歌曲多以sol、do、mi、sol 自然泛音列的五聲音階為音組織素材，根據節奏的變化、分節反覆式（strophic form）或通作式（through-composed）的結構組合創寫作品，迥異於日常生活的非祭儀性歌謠。受到時節與禁忌的祭儀性歌曲，其結構的完整性與曲目的多元都來得比非祭儀性歌謠龐大許多。</li>
                                    <li style="font-size: 20px;">　　一般來說，根據時序與功能的劃分，邵族的祭儀性歌謠可以分成mulalu與lus’an兩類，前者由女性的先生媽（shinshi）主事， 而後者由男性的鑿齒祭司（paruparu）主導，這兩大儀式音樂系統，又分別開衍出許多細小的儀式結構，宛如一個大宇宙與小宇宙的對應，概約來說，mulalu是由傳統的sol、do、（re）、mi、sol自然泛音列的五聲音階為音組織素材，曲調以一個完全四度上加兩個二度為主，偶有裝飾性的高音sol至do完全五度出現，旋律音型多半以do至低音sol四度下行為結束。也因為它是由女性祭司演唱的歌樂，所以是一種純粹的女聲複音歌樂；而lus’an音樂就複雜許多，除了祭司的參與之外，邵族男女族人，甚至一般的遊客都能共同加入祭典、分享喜樂，因此，lus’an音樂為一種男女歌謠的混聲性質，除了傳統sol、do、（re）、mi、sol自然泛音列的五聲音階為音組織素材之外，lus’an音樂尤其是牽田歌曲（shmayla）多以la音為主的羽調式，因此，lus’an音樂除了代表對該年豐收的慶祝之外，又帶有對傳統、祖靈遙念的感傷之情。</li>
                                    <p>
                                        參考資料:<br>
                                        原住民族委員會<br>
                                        國家文化委員會
