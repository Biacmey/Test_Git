                    ...
                    <div class=" col-lg-9 ">
                        <div>
                            <ul style="font-size: 25px; color: black; margin: 30px;">
                                <font face="DFKai-sb">
                                    <h1 class="musictop">歌 謠 介 紹-排灣族</h1>
                                    <ul style="margin: 10px;">
                                    <li style="font-size: 20px;"> 　　排灣族音樂從歷史演變而言，可分傳統音樂與之後演變的音樂，兩者可以日治初期為界線；若從音樂內容，則可概分為歌樂及器樂。傳統歌樂隨著族人歲時祭儀、生命禮俗以及一般生活節奏適時表達，歌曲與部落生活形態、傳統生活方式可說密不可分。</li>
                                    <li style="font-size: 20px;"> 　　歌曲形式，若兼顧聲部組織情形，可分為單音性和多音性歌謠，單音性歌謠又可細分為唸謠與單音式歌謠；多音性歌謠則可細分為異音式、持續低音式與同音反覆唱法歌謠三種。若從歌詞的內容分類，可分為童謠、祭儀性歌謠、生活歌謠三類，其中以生活歌謠歌唱場合最多。所有歌謠中以童謠（senai na adriyadriyan）、生活歌謠中的情歌（senai na maqacuvucuvung）、結婚哭調、搭配特定舞步歌唱的勇士歌舞四種最為特殊。</li>            
                                    <li style="font-size: 20px;"> 　　排灣族歌曲演唱形式，與族人平日口語對答方式頗類似，歌唱時以領唱、和腔，結合對唱方式呈現。實際歌唱時，一段實詞一段虛詞交互呈現，實詞艱澀抽象，詞意難懂，歌者形容如中文的「文言文」；虛詞是由固定曲調組合而成，每唱一段實詞，就穿插虛詞段落，這種唱法與早期歐洲「副歌」（refrain）頗類似。歌謠旋律進行除了小部分勇士歌舞較激烈，其餘歌曲曲調上下行進音域都很小，有的甚至似唸謠，如童謠與祭典歌謠皆是。歌謠曲調通常循「骨幹音」歌唱，一首歌往往只以一段骨幹音不斷反覆，而每次反覆均套入即興表達歌詞。歌詞因屬即興，因此在歌唱實詞（parutavak）時，優雅、高尚且不做作的完美歌詞表達，成了族人評價歌手的重要標準。排灣族人歌唱均為集體式，族人擅長以冷靜、內斂、機智的方式與對方對唱，對唱除了可化解誤會、達成娛樂效果並解決部落裡重大決策外，更可藉由這樣的交流機制，建立最佳的互動模式，維持人與人之間良好的關係。</li>
                                    <li style="font-size: 20px;"> 　　器樂部分，單管及雙管鼻笛、單管及雙管口笛（單管稱pakulalu；雙管稱lalingedan）與口簧琴（ljaljuveran、barubaru）均為傳統樂器，吹奏時機在喪事、追求女子、自娛、思念某人之時。值得一提的，是古老的雙管鼻笛構造，並列的兩支，一支無指孔，另一支三（或四或五）個指孔，奏出的聲響，與複音歌謠的曲調，下方聲部呈現持續低音而上方聲部自由進行的情形相仿，歌樂與器樂間到底有否互為影響，尚待深入研究。</li>
                                    <li style="font-size: 20px;"> 　　日治時期至今，排灣族音樂有了許多的變化，傳統生活方式既已不復見，歌樂和器樂於是改以「模擬傳統」、「表演」的形式呈現。近幾年，音樂中的音階、旋律、形式等內涵，笛子的形制、音樂美學觀以及整體風格等，都有漸漸模仿歐洲音樂的傾向。今日排灣族傳統音樂，透過學校繼續傳承，1941年1月1日創校的今屏東縣草埔國小，1977年起由戴錦花等指導兒童合唱，創下五年全省合唱比賽優等冠亞軍的紀錄，贏得「臺灣維也納」的美譽。1998年起由周明傑等指揮，2004年灌錄排灣族歌謠CD，獲2005年最佳原住民流行音樂專輯獎，該校以及後來也出版教材的泰武國小、三地國小，均成為排灣歌謠重要的發展學校。</li>
                                    <p>
                                        參考資料:<br>
                                        原住民族委員會<br>
                                        國家文化委員會
