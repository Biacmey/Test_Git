                    ...
                    <div class=" col-lg-9 ">
                        <div>
                            <ul style="font-size: 25px; color: black; margin: 30px;">
                                <font face="DFKai-sb">
                                    <h1 class="musictop">歌 謠 介 紹-卑南族</h1>

                                    <ul style="margin: 10px;">
                                    <li style="font-size: 20px;"> 　　卑南族主要的八個部落，宗教及祭儀歌舞的內容與名稱上均各具特色，不盡相同。卑南人對於音樂的概念，可由其語言理解。在卑南語中，有歌有舞的名稱，但在生活中，歌舞常是不分的。歌，在卑南語中稱snay，唱歌則稱smenay。舞則有兩個字，一為waarakan，係舞蹈之統稱，另一為likasaw，專指一種婦女舞蹈方式，兩者差別在於前者牽手而舞，後者不牽手。跳舞則稱muarak或malikakasaw。</li>
                                    <li style="font-size: 20px;"> 　　卑南音樂主要可區分為「祭儀」與「生活」兩類。「祭儀」之歌方面，卑南人並不將之視為歌（snay）的範疇，稱呼有專有名詞。但這類歌曲均與信仰祭儀有關，具有旋律、節奏，符合音樂的一般定義，主要有yaulas（通靈之歌）、palrimulrimu（挑釁歌）、kudraw（祭猴之歌）、isuwalray alialian（招喚夥伴來跳舞之歌）、paduduk（快板舞）、pairairaw（英雄詩）、benanban（慰喪歌）、tu trangisan（哭調）及pakaudal（祈雨之歌）。目前仍舉行的定時祭儀，有除草完工慶（mugamut）、收穫祭（知本稱venarasa’、南王稱mulaliyaban）、猴祭（知本稱temuaungaungay、南王稱basibas或mangayangayaw）及大獵祭（mangayaw）。其中，除草祭、猴祭及大獵祭均有專屬歌舞。「生活」歌謠方面，包含慶典之歌（a snay dramasasangal）、古謠（a snay a bulre trenganan）、情歌（markasagar）、工作歌、兩個字抒情與歡樂歌、哄小孩之歌（maenen）與小孩之歌（senay dra lralrak）等七類。</li>
                                    <li style="font-size: 20px;"> 　　卑南音樂以歌唱為主，其唱法多樣，主要有吟誦（mengangadir）、獨唱（misasasmenay）、領唱（temga）、合唱（二人合唱稱mukasa smenay，眾人合唱稱mukasakasasmenay）、輪唱（matalitalyu）、對唱（matatubang）、接唱（marebulabulas）等方式與表達詞語。</li>
                                    <li style="font-size: 20px;"> 　　樂器方面，日治末期尚存的包括口簧琴lruber、弓琴ratuk、縱笛palingalungan、橫笛alidang、鈴類tawlriyulr等。目前僅餘鈴類樂器，使用上多與祭儀活動有關。</li>
                                    <p>
                                        參考資料:<br>
                                        原住民族委員會<br>
                                        國家文化委員會
