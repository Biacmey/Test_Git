        ...
        <div class="container-fluid ml-auto mr-auto" style="margin-bottom: 150px; width: 92%">
            <div class="row">
                ...
                <div class=" col-lg-9 container">
                    <h1 style="color: brown;"><b>目前均一價299!!!!</b></h1>
                    <div class="col-12">
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd1-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/CD2-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd3-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd4-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd5-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd6-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd7-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd8-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd9-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd10-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd11-1.jpg" alt="CD" width="250px" height="250px"></a><br>
                        <a href="./商品/1.php"><img style="margin-left: 20px; margin-top: 20px;" src="../img/cd12-1.jpg" alt="CD" width="250px" height="250px"></a>
                        <br>
