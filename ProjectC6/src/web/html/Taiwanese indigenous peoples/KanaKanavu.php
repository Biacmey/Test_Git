                    ...
                    <div class="col-lg-9 ">
                        ...
                        <ul style="font-size: 25px; color: black; margin: 30px;">
                            <font face="DFKai-sb">
                                ...
                                <li style="font-size: 20px;">傳統語言為卡那卡那富語，但目前通用語是布農語。</li>
                                <li style="font-size: 20px;">
                                    卡那卡那富族的重要祭儀有「Mikong（米貢祭）」、「Pasikarai（河祭）」等。<br>
                                    傳統狩獵的方式有三種 Uma'anupu (帶狗狩獵) / Rumaringee (陷阱) / Aracakaan (狩獵)</li>
                                <li style="font-size: 20px;">
                                    民族起源:<br>
