...
<body style="margin-top: 50px;">
        ...
        <div class="container-fluid ml-auto mr-auto" style="margin-bottom: 150px; width: 92%">
            <div class="row">
                ...
                <div class=" col-lg-9 container">
                    <div class="col ">
                        <img class="col-3" src="../img/威仁1.jpg" style="float: left; margin-top: 20px; margin-left: 20px;">
                        <h1 class="contant">親愛的朋友，您好!歡迎使用線上洽談系統</h1>
                        <form>
                            <p>姓名<input type="text" style="margin-left: 80px;" placeholder="請輸入你的姓名" required="required"></p>

                            <p>身分證字號<input type="password" style="margin-left: 38px;" placeholder="請輸入你的身分證字號" required="required"></p>
                            <p>連絡電話<input type="tel" style="margin-left: 52px;" placeholder="請輸入你的電話" required="required"></p>

                            <p>電子郵件<input type="email" style="margin-left: 52px;" placeholder="請輸入你的信箱" required="required"></p>
                            <p>日期<input style="margin-left: 80px; margin-bottom: 10px;" type="date" placeholder="年/月/日" required="required"></p>
                            你想合作的對象
                            <select name="年級" style="margin-left: 10px;">
                                　<option>阿美族</option>
                                　<option>賽夏族</option>
                                　<option>鄒族</option>
                                　<option>泰雅族</option>
                        ...
                        <br><br>
                        <p style="font-size: 30px;">如果無法順利預約的話歡迎聯絡我們:0900-888888</p>
                        <p style="font-size: 30px;">電子信箱:abcd0123@gmail.com</p>
                        <p style="font-size: 30px;">或直接到我們的地址找我們:台中市西屯區文華路200號</p>
                        <input type="submit" value="查詢有空位的日期日期" style="margin-top: 20px; margin-left: 20px;" class="col" onclick="myFunction()">
                        <b>
                            <p id="demo" class="conjs"></p>
                        </b>
    ...
    <script>
        function myFunction() {
            ...
            document.getElementById("demo").innerHTML = "不好意思，目前尚有空位請挑選其他的時間!!!";
        }
    </script>
